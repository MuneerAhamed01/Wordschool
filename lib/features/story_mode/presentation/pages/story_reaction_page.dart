...
class StoryReactionPage extends StatelessWidget {
  const StoryReactionPage({super.key, required this.clueIndex});
      ...
      builder: (context, detectiveCase, flowState) {
        ...
        return StoryNarrativeScaffold(
          ...
          continueLabel: clueIndex >= StoryFlowGating.maxClueIndex
              ...
              : 'Next clue',
          onContinue: () {
            context.push(StoryFlowGating.nextRouteAfterReaction(clueIndex));
          },
        );
      },
    );
