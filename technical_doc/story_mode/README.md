...
| 1 — Backend | [phase-01-backend.md](./phase-01-backend.md) | Not started | 0/6 steps | — |
...
**Not yet in app:** Cloud Functions, Remote Config, Analytics, ads/IAP, `share_plus`, story data layer / full UI.
